...
import { SiderMenuProps } from "@/components/pro-layout/components"
...
const getPaddingLeft = (hasLeftPadding, collapsed = undefined, collapsedWidth, siderWidth) => {
  if (hasLeftPadding) {
    return collapsed ? collapsedWidth || 80 : siderWidth
  }
  return 0
}
        ...
        <ContainerQuery query={MediaQueryEnum} onChange={handleMediaQuery}>
          <Layout
            class={{
              ...
              "ant-pro-fixedheader": fixedHeader,
              ...mediaQuery
            }}
          >
            <Index {...{ props: cdProps }} collapsed={collapsed} onCollapse={handleCollapse} />
            <Layout
              class={[layout]}
              style={{
